...
def draw_bar_plot():
    ...
    df_bar['month'] = pd.Categorical(df_bar['month'], catagories = months)
...
def draw_box_plot():
    ...
    sns.boxplot(x = df_box['month'], y = df_box['value'], order = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], ax = axs[1]).set(xlabel = 'Month', ylabel = 'Page Views')
